...
pub static BUILTINS_GENERATED: &[ComponentDef] = &[
    ...
    ComponentDef {
        ...
        kind: ComponentKind::Leaf(LeafDef {
            ...
            PropDef { name: "justify_center", setter: "justify_center", value: PropValue::Flag },
    ...
    ComponentDef {
        ...
        kind: ComponentKind::Leaf(LeafDef {
            ...
            PropDef { name: "mask_char", setter: "mask_char", value: PropValue::Custom },
            PropDef { name: "has_custom_bg", setter: "has_custom_bg", value: PropValue::Bool },
            PropDef { name: "has_custom_border", setter: "has_custom_border", value: PropValue::Bool },
            PropDef { name: "has_custom_focus_border", setter: "has_custom_focus_border", value: PropValue::Bool },
            PropDef { name: "custom_bg", setter: "custom_bg", value: PropValue::Color },
    ...
    ComponentDef {
        ...
        kind: ComponentKind::Leaf(LeafDef {
            ...
            PropDef { name: "state", setter: "state", value: PropValue::Custom },
            PropDef { name: "toggled", setter: "toggled", value: PropValue::Bool },
            PropDef { name: "selected_item", setter: "selected_item", value: PropValue::Custom },
            ],
    ...
    ComponentDef {
        ...
        kind: ComponentKind::Leaf(LeafDef {
            ...
            needs_app: true,
            needs_window: false,
            props: &[PropDef { name: "column", setter: "column", value: PropValue::Custom },
            PropDef { name: "columns", setter: "columns", value: PropValue::Custom },
            PropDef { name: "row", setter: "row", value: PropValue::Custom },
            PropDef { name: "rows", setter: "rows", value: PropValue::Custom },
            PropDef { name: "selected", setter: "selected", value: PropValue::UInt },
            ],
            events: &[("on_select", "on_select"), ],
            supports_text_child: false,
    ...
    ComponentDef {
        ...
        kind: ComponentKind::Leaf(LeafDef {
            ...
            PropDef { name: "selected_ids", setter: "selected_ids", value: PropValue::Custom },
            PropDef { name: "selected_id", setter: "selected_id", value: PropValue::Custom },
            PropDef { name: "selection_mode", setter: "selection_mode", value: PropValue::TreeSelectionMode },
            ],
            events: &[],
            supports_text_child: false,
            children_before_render: false,
    ...
    ComponentDef {
        ...
        kind: ComponentKind::Leaf(LeafDef {
            ...
            PropDef { name: "selected", setter: "selected", value: PropValue::Bool },
            PropDef { name: "disabled", setter: "disabled", value: PropValue::Bool },
            PropDef { name: "checkbox", setter: "checkbox", value: PropValue::Bool },
            PropDef { name: "checked", setter: "checked", value: PropValue::Bool },
            PropDef { name: "indeterminate", setter: "indeterminate", value: PropValue::Bool },
            ],
            events: &[("on_click", "on_click"), ("on_toggle", "on_toggle"), ("on_check", "on_check"), ("on_double_click", "on_double_click"), ],
            supports_text_child: false,
            children_before_render: false,
            unwrap_children: false,
            slots: &[],
