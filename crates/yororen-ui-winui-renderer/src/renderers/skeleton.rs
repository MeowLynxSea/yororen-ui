//! `WinUISkeletonRenderer` — default `SkeletonRenderer` impl.
...
pub struct WinUISkeletonRenderer;

// Inherent helpers — *not* part of the trait surface.
impl WinUISkeletonRenderer {
...
impl SkeletonRenderer for WinUISkeletonRenderer {
