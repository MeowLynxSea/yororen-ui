//! `WinUIFocusRingRenderer` — default `FocusRingRenderer` impl.
...
pub struct WinUIFocusRingRenderer;

// Inherent helpers — *not* part of the trait surface.
impl WinUIFocusRingRenderer {
...
impl FocusRingRenderer for WinUIFocusRingRenderer {
