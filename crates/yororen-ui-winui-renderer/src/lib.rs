...
//! `WinUIXxxRenderer` struct (the renderer impl). The
...
//!
//! ```text
//! themes/*.json ──▶ winui-renderer ──▶ core ──▶ gpui ce
//! ```
//!
//! Apps depend on this crate when they want the WinUI look.
...
pub use themes::{
    install, install_with, register_winui_renderers, winui_dark, winui_for, winui_light,
};
